...
<head>
	...
	<title>[ HTML Attributes Reference ]</title>
...
<body>
	...
	<div id="container">
		...
		<header>
			...
			<p class="baseline">Because we cannot remember everything</p>
		</header>
        ...
        <datalist id="elsList">
          ...
          <option value="figcaption">
          <option value="figure">
          <option value="font">
          <option value="footer">
          <option value="form">
          <option value="frame">
          <option value="frameset">
          <option value="h1">
          <option value="h2">
          <option value="h3">
          <option value="h4">
          ...
          <option value="nav">
          <option value="nextid">
          <option value="noembed">
          <option value="noscript">
          <option value="object">
          <option value="ol">
